/*List<dynamic> itemset_1(var I, Map<dynamic, dynamic> D) {
  var minsupp = 5;
  var prev = [];
  for (var i in I) {
    var supp = 0; // support
...
List<dynamic> validate_candidate(var candidate, Map<dynamic, dynamic> D) {
  var minsuppq = 5;
  var result = [];
...
List<dynamic> apriori_reel(var I, Map<dynamic, dynamic> D) {
  var minsupp = 5;
  var result = [];
  print('Calcul des 1-itemsets fréquents ...');
  var L1 = itemset_1(I, D);
  print('L1 calculé.');
